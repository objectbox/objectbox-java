...
| Artifact ID                            | Android APIs | Admin                    | Android database library |
|----------------------------------------|--------------|--------------------------|--------------------------|
| `objectbox-android`                    | ✓            | no-op API                | Basic                    |
| `objectbox-android-objectbrowser`      | ✓            | API, resources, manifest | Basic + Admin            |
| `objectbox-sync-android`               | ✓            | no-op API                | Sync                     |
| `objectbox-sync-android-objectbrowser` | ✓            | API, resources, manifest | Sync + Admin             |
