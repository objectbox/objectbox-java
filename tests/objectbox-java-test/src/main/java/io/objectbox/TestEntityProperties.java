...
public class TestEntityProperties implements Properties {
    ...
    public final static Property SimpleLong = new Property(3, long.class, "simpleLong", false, "simpleLong");
    public final static Property SimpleString = new Property(4, String.class, "simpleString", false, "simpleString");
    public final static Property SimpleFloat = new Property(5, float.class, "simpleFloat", false, "simpleFloat");
